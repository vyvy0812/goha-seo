...
# Outline: Định chế tài chính là gì? Phân loại và vai trò

| Field | Value |
|---|---|
| Title | Định chế tài chính là gì? Phân loại và vai trò (47 ký tự) |
| Meta Description | Tìm hiểu định chế tài chính là gì, phân loại định chế tài chính trung gian và bán trung gian, vai trò trong nền kinh tế. Cập nhật các định chế tài chính quốc tế nổi bật. (150 ký tự) |
| KW chính | định chế tài chính |
| KW phụ | định chế tài chính là gì |
...
## 2. Đặc điểm cơ bản của định chế tài chính

## 3. Vai trò và chức năng của định chế tài chính trong nền kinh tế
### 3.1. Kiểm soát dòng tiền và nguồn cung vốn
### 3.2. Hạn chế rủi ro cho nhà đầu tư
### 3.3. Tiết kiệm chi phí giao dịch
...
## 8. Những câu hỏi thường gặp về định chế tài chính
### 8.1. Định chế tài chính trung gian khác gì so với bán trung gian?
### 8.2. Các định chế tài chính là gì và có bao nhiêu loại theo pháp luật Việt Nam?
### 8.3. Định chế tài chính quốc tế ảnh hưởng thế nào đến kinh tế Việt Nam?
