...
- **[Brand 3]**: [URL]
---
[Signature viết ra đầy đủ, in nghiêng — BẮT BUỘC CHỌN ĐÚNG THEO CONTEXT CHỦ ĐỀ như Mục 11]
```
...
- [ ] Chữ ký viết đầy đủ, in nghiêng, sau `---`, BẮT BUỘC MATCH VỚI CONTEXT BÀI VIẾT
